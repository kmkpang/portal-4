...
$webpackService->embedReactJsCss('modWebportal{Module_name}Ui');
...
<div id="modWebportal{Module_name}Ui" class="<?php echo $moduleClassName ?>" data-hint="<?php echo $moduleParams ?>"></div>
