...
$webpackService->embedReactJsCss('modWebportalPropertiesUi');
...
<div id="modWebportalPropertiesUi-<?php echo $module->id?>" data-type="modWebportalPropertiesUi" class="<?php echo $moduleClassName ?>" data-hint="<?php echo $moduleParams ?>"></div>
