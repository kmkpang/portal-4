...
$webpackService->embedReactJsCss('modWebportalContactusUi');
...
<div id="modWebportalContactusUi" class="<?php echo $moduleClassName ?>" data-hint="<?php echo $moduleParams ?>"></div>
