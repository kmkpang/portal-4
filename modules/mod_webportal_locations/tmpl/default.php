...
$webpackService->embedReactJsCss('modWebportalLocationsUi');
...
<div id="modWebportalLocationsUi" class="<?php echo $moduleClassName ?>" data-hint="<?php echo $moduleParams ?>"></div>
