...
$webpackService->embedReactJsCss('modWebportalPropertyDetailUi');
...
<div id="modWebportalPropertyDetailUi" class="<?php echo $moduleClassName ?>" data-hint="<?php echo $moduleParams ?>"></div>
