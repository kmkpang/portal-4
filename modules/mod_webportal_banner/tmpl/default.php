...
$webpackService->embedReactJsCss('modWebportalBannerUi');
...
<div id="modWebportalBannerUi-<?php echo $module->id?>" data-type="modWebportalBannerUi" class="<?php echo $moduleClassName ?>" data-hint="<?php echo $moduleParams ?>"></div>
