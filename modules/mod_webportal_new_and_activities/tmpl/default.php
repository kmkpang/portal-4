...
$webpackService->embedReactJsCss('modWebportalNewAndActivitiesUi');
...
<div id="modWebportalNewAndActivitiesUi" class="<?php echo $moduleClassName ?>" data-hint="<?php echo $moduleParams ?>"></div>
