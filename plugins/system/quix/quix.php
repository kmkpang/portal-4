...
@media screen and (min-width: 0\0), screen\0 {
  ...
  public function addQuixCoreVars()
  {
    ...
    $script = '
    <script data-cfasync="false">var QUIX_ROOT_URL = "' . JUri::root() . '";window.FILE_MANAGER_ROOT_URL = "' . JUri::root() . 'images/";</script>';
  ...
  */
  public static function addQuixTrapCSSfrontend()
  {
    ...
    $styleSheets = $quixCssArray + $quixArray + $_styleSheets;
  ...
  */
  ...
  public function fixAdminTools()
  {
    ...
    if($isPro) { 
      ...
      if($result == 'com_quix') return false;
